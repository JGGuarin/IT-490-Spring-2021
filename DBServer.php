...
function requestProcessor($request)
{
    ...
    for ($i = 0; $i < sizeof($request); $i++)
    {
        ...
        switch ($request[$i]['type'])
        {
            /*
            case "get":
                $responseArray[$i] = get($request[$i]['fieldname']);
            */
            case "authenticate":
                $responseArray[$i] = authenticate($request[$i]['username'],$request[i]['password']);
            case "getUserId":
                $responseArray[$i] = getUserId($request[$i]['username'],$request[$i]['password']);
            /*
            case "getTeamID":
                return getTeamID($request[$i]['userID'],$request['leagueID']);
            
            case "getTeamName":
                return getTeamName($request[$i]['teamID']);
...
//////////////////////////////////////////////////////////////////////////////////
// From testRabbitMQServer.php of rewrite-attempt branch as of 03/15/21 at 8:40 PM
//////////////////////////////////////////////////////////////////////////////////
